...
\begin{center}
\textit{``You search the Scriptures, for in them you think you have eternal life; and these are they which testify of Me.''}\\[0.2em]
...
\lettrine[lines=2, loversize=0.1, nindent=0.5em]{\color{chaptercolor}T}{he whole Bible} has one magnificent centre --- the Person and Work of Christ. From Genesis to Revelation every line moves toward Him and finds its completion in Him.
...
\begin{center}
\textit{``Behold! The Lamb of God who takes away the sin of the world!''}\\[0.2em]
...
\lettrine[lines=2, loversize=0.1, nindent=0.5em]{\color{chaptercolor}W}{hen we begin} studying the offerings, we must remember that Christ Himself is infinite. His Person cannot be measured, mapped, or mastered. Paul says that even one glory of Christ --- His love --- has breadth, length, depth, and height (Eph.\ 3:18).
...
\begin{center}
\textit{``We have such a High Priest, who is seated at the right hand of the throne of the Majesty in the heavens.''}\\[0.2em]
{\small\textsc{--- Heb.\ 8:1}}
\end{center}
\vspace{0.8em}

\section{The Eternal High Priest}

\lettrine[lines=2, loversize=0.1, nindent=0.5em]{\color{chaptercolor}A}{aron's priesthood} was temporary and symbolic. Christ's priesthood is eternal and real --- the fulfillment of all Levitical shadows.
...
\begin{tabularx}{\textwidth}{lXX}
\toprule
\textbf{Step} & \textbf{Lev.\ 8} & \textbf{Fulfilled in Christ} \\
\midrule
...
\section{The Three Appearances (Lev.\ 9 and Heb.\ 9)}

\begin{center}
\begin{tabularx}{\textwidth}{llXX}
\toprule
\textbf{Time} & \textbf{Lev.\ 9} & \textbf{Christ's Appearance} & \textbf{Heb.\ 9} \\
\midrule
...
\begin{center}
\textit{``By His own blood He entered the Most Holy Place once for all, having obtained eternal redemption.''}\\[0.2em]
...
\lettrine[lines=2, loversize=0.1, nindent=0.5em]{\color{chaptercolor}A}{mong all the} chapters of the Pentateuch, one chapter rises like the pinnacle of a holy mountain --- Lev.\ 16, the Day of Atonement.
...
\begin{center}
\textit{``For I am the LORD your God: you shall therefore sanctify yourselves, and you shall be holy; for I am holy.''}\\[0.2em]
...
\lettrine[lines=2, loversize=0.1, nindent=0.5em]{\color{chaptercolor}A}{fter the atonement} of Lev.\ 16, the next great section unfolds the principle of holiness --- what it means to live as a cleansed and separated people.
...
\section{Laws of Cleanness (Lev.\ 11--15)}
...
\section{The Sanctity of Blood (Lev.\ 17)}
...
\section{Moral and Ethical Holiness (Lev.\ 18--20)}
...
\begin{center}
\textit{``But when the fullness of the time had come, God sent forth His Son, born of a woman, born under the law.''}\\[0.2em]
{\small\textsc{--- Gal.\ 4:4}}
\end{center}
\vspace{0.8em}
...
\lettrine[lines=2, loversize=0.1, nindent=0.5em]{\color{chaptercolor}L}{eviticus 23 presents} the Feasts of the Lord --- not Israel's feasts, but Yahweh's appointed times (\heb{מוֹעֲדִים}, \textit{mo'adim}). They are the divine blueprint of God's redemptive history.
...
\subsection{Passover (Lev.\ 23:4--5)}
...
\subsection{Pentecost (Lev.\ 23:15--22)}
...
\subsection{Feast of Trumpets (Lev.\ 23:23--25)}
...
\subsection{Day of Atonement (Lev.\ 23:26--32)}
...
\subsection{Feast of Tabernacles (Lev.\ 23:33--44)}
...
\begin{center}
\textit{``Come to Me, all you who labor and are heavy laden, and I will give you rest.''}\\[0.2em]
...
\lettrine[lines=2, loversize=0.1, nindent=0.5em]{\color{chaptercolor}L}{eviticus 25--26} concludes the covenantal section by revealing three great theological realities:
...
\section{The Covenant Blessings and Curses (Lev.\ 26)}

\subsection{Blessings for Obedience (26:1--13)}

\begin{scripture}
``I will walk among you, and be your God, and you shall be My people.''
\scriptureref{Lev.\ 26:12}
\end{scripture}
...
\begin{center}
\textit{``I beseech you therefore, brethren, by the mercies of God, to present your bodies a living sacrifice, holy, acceptable to God, which is your reasonable service.''}\\[0.2em]
...
\lettrine[lines=2, loversize=0.1, nindent=0.5em]{\color{chaptercolor}L}{eviticus ends} not with the sacrifices, feasts, or jubilees, but with vows and dedications --- the voluntary acts of consecration.
...
\begin{scripture}
``The grace of God that brings salvation has appeared... teaching us to live soberly, righteously, and godly in this present world.''
\scriptureref{Tit.\ 2:11--12}
\end{scripture}
