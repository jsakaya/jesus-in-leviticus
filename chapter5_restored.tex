...
\toprule
\textbf{Hebrew} & \textbf{Meaning} & \textbf{Reference} & \textbf{Fulfillment} \\
\midrule
...
\heb{נָזַה} \textit{nāzāh} & To sprinkle & Lev 14:7 & Heb 12:24 --- ``Blood of sprinkling'' \\
\bottomrule
\end{tabularx}
\end{table}
...
Leviticus 11--15 teaches that God's people must discern between clean and unclean in every aspect of life. Some animals or conditions symbolized spiritual truths, not moral sin.
...
\textbf{Fulfillment:} The Virgin Birth breaks the chain of defilement --- \emph{"That holy thing which shall be born of you shall be called the Son of God."} (Luke 1:35)
...
\textbf{Fulfillment:} Christ cleanses the leper by touch (Mark 1:40--45), signifying that holiness is \textbf{contagious in Him}, not defilement. In His humanity, He touched corruption without becoming unclean --- \textbf{He is purity itself}.
...
Leviticus 15 anticipates the need for \textbf{inward cleansing} --- fulfilled in the new birth and sanctification by the Spirit (Titus 3:5).
...
This chapter is called the \textbf{Levitical Sermon on the Mount}. Its repeated phrase, \emph{"I am the LORD,"} anchors every ethical command in divine character.
...
The chapter concludes with the \textbf{penalty for defilement} --- death or separation --- underscoring the seriousness of sin.
...
Cleansing leads to consecration; holiness is a \textbf{relationship we maintain}, not a condition we achieve. The refrain "I am the LORD" in Leviticus 19 appears fifteen times --- God Himself is the measure and motive of holiness.
...
God separates to sanctify: light from darkness, Israel from nations, clean from unclean.
...
\toprule
\textbf{Hebrew} & \textbf{Meaning} & \textbf{Reference} & \textbf{NT Fulfillment} \\
\midrule
\heb{טָהוֹר} \textit{ṭāhôr} & Clean & Lev 11:47 & Matt 5:8 \\
\heb{טָמֵא} \textit{ṭāmēʾ} & Unclean & Lev 11:47 & Mark 7:23 \\
\heb{קָדַשׁ} \textit{qāḏaš} & To sanctify & Lev 20:7 & John 17:19 \\
\heb{בָּדַל} \textit{badal} & To separate & Lev 20:24 & 2 Cor 6:17 \\
\heb{דָּם} \textit{dām} & Blood & Lev 17:11 & Heb 9:14 \\
\bottomrule
\end{tabularx}
\end{table}
...
Holiness is God's ownership expressed in daily life, not self-made purity. The God who cleanses also claims. The blood that redeems also sanctifies. In Christ, every barrier --- moral, ceremonial, or spiritual --- is overcome. He is both \textbf{the Cleansing Fountain} and \textbf{the Holy Place}.
